...
const SearchPage = (props) => {
    ...
    const getLatLng = async () => {
        ...
        const locns = locationResponses.map(locationResponse => locationResponse.data.results.length > 0 ? {lat: locationResponse.data.results[0].geometry.location.latitude, lng:imageResponse.data.results[0].geometry.location.longitude} : null);
