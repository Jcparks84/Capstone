...
const SearchPage = (props) => {
    ...
    const breweryStree = brewery.street
    const breweryCity = "%20" + brewery.city
    const breweryState = "%20" + brewery.state
	const [lat, setLat] = useState(37.0902)
    const [lng, setLng] = useState(-95.7129)
    const address = breweryStree+breweryCity+breweryState

    console.log("street......", breweryStree)
