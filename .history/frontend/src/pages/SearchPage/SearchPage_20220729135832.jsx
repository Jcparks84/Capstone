...
const SearchPage = (props) => {
    ...
    function getAddress(){ 
        for (let index = 0; index < array.length; index++) {
            const results = breweryStreet[index] + ' ' + breweryCity[index] + ' ' + breweryState[index];
        console.log(results)
        setAddress(results)
    }}
    ...
    return (
        <div className="container">
            ...
            <SearchBar placeholder='Enter brewery or city' handleChange={(e) => console.log(e.target.value)} getBrewery={getBrewery} getAddress = {getAddress}/>
            <div>
