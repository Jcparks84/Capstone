...
const SearchPage = (props) => {
    ...
    const [sortedRating, setSortedRatings] = useState([])
        ...
        for (let index = 0; index < brewery.length; index++) {
            ...
            try {
               await axios.get(
                    ...
                    // console.log('brewery_id ratings HHHHHHH', response.data);
                    const avg = await findAvg(response.data.data)
                    // console.log('avg ratings AAAAAAAA', avg, element.id);
    ...
    console.log(ratings,"HHHHHHHHHH")
