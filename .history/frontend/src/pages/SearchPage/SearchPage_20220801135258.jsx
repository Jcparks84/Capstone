...
const SearchPage = (props) => {
    ...
    async function getBrewery(search) {
        ...
        const locns = locationResponses.map(locationResponse => locationResponse.data.results.length > 0 ? {lat: locationResponse.data.results[0].geometry.location.latde, lng:locationResponse.data.results[0].geometry.location.longitude} : null);
