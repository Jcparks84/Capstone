...
const SearchPage = (props) => {
    ...
    const getLatLng = async (arr) => {
        console.log("array", arr          const locationPromises = arr.map(location => axios.get(`https://maps.googleapis.com/maps/api/geocode/json?address=${location.address}&key=${apiKey}`));
