...
const SearchPage = (props) => {
   ...
   async function getBreweryAddress(brewery) {
    Geocode.setApiKey("AIzaSyDyLYju-VigOrqW0mLBu8hOok05-Va7FMM");
    Geocode.setLanguage("en");
    Geocode.setRegion("es");
  
    Geocode.fromAddress(brewery[0].street, brewery[0].addre).then(
      (response) => {
    ...
    return (
        <div className="container">
            ...
            <SearchBar placeholder='Enter brewery or city' handleChange={(e) => console.log(e.target.value)} getBrewery={getBrewery} getBreweryAddress={getBreweryAddress}/>
            <div>
                <Map brewery = {brewery}/>
            </div>
            <table>
