...
const SearchPage = (props) => {
    ...
    const getLatLng = async (array) => {
        const locationPromises = array.map(location => axios.get(`https://maps.googleapis.com/maps/api/geocode/json?address=${location.address}&key=${apiKey}`));
     ...
     console.log('locationRespponse', locationResponses)
        ...
        const updatedArray = array.map((location, index) => ({ ...location, longitude: locns[index].lng, latitude:  locns[index].lat}));
