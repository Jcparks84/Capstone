...
const SearchPage = (props) => {
    ...
    const updatecenter = (locations) => {
         const locationP = arr.map(location => axios.get(`https://maps.googleapis.com/maps/api/geocode/json?address=${location.state + ' ' + location.city + ' ' + location.street }&key=${apiKey}`));
